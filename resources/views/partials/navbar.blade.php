<nav
    ...
    <div id="dropdownDefaultButton" data-dropdown-toggle="dropdown"
        ...
        <span class="text-white poppins-medium">Admin</span>
...
<div id="dropdown" class="z-[999] hidden bg-white divide-y divide-gray-100 rounded-lg shadow-md w-44 dark:bg-gray-700">
    <ul class="text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
        <li>
            <a href="#"
                class="block px-4 py-4 rounded-lg text-red-600 poppins-medium hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                Keluar
            </a>
        </li>
    </ul>
